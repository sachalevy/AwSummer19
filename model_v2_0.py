...
def read_files(files):
	...
	train_df.drop(['index', 'minutes', 'p1_ioc', 'p2_ioc', 'p1_name', 'p2_name',
		...
		'player_1_rank_points_avg_l7', 'player_2_rank_points_avg_l7', 'player_1_rank_points_std_l7',
		'score', 'tourney_date', 'tourney_level', 'tourney_name', 'player_2_rank_points_std_l7',
		'player_1_results_perc_l7_p25','player_1_results_perc_l7_p50','player_1_results_perc_l7_p75',
		'player_1_results_std_l7', 'player_1_results_avg_l7', 'player_1_results_std_l3',
		'player_1_results_avg_l3', 'player_1_results_l','player_2_results_perc_l7_p25','player_2_results_perc_l7_p50','player_2_results_perc_l7_p75',
		'player_2_results_std_l7', 'player_2_results_avg_l7', 'player_2_results_std_l3',
		'player_2_results_avg_l3', 'player_2_results_l'],
       axis = 1, inplace = True)
	...
	train_X = train.loc[:, 'p1_height':'player_1_Svgms_perc_l7_p75']

	test_Y = test.loc[:, 'target_1':'target_0']
	test_X = test.loc[:, 'p1_height':'player_1_Svgms_perc_l7_p75']
